...
st.header("Conclusiones y Sugerencias")
st.markdown("***")

st.write("""Con el analisis que se ha realizado determinamos que la primera medida a tomar es realizar la apertura de un 
nuevo centro de almacenamiento - hub en el estado de Mina Gerais. Esto beneficiara en primera medida la 
region la region Sudeste y Nordeste  principalmente.""")
st.markdown("***")
st.write("""En cuanto al analisis de los tiempos de entrega, podemos sugerir cambios en 3 puntos principales, en un primer punto
    ...
    una billetera virtual que permita que el pago del cliente ingrese de manera agil. """)
st.write("""En un segundo punto, sugerimos implementar un sistema de puntos  y logros para los vendedores que despachen su producto lo mas rapido posible. """)
st.write("""En tercer lugar recomendamos revisar la posibilidad de que en ciudades como Sao Paulo se  implemente para
la paqueteria  liviana un servicio de moto-envios, ya sea propio o de manera tercerizada que permita optimizar los tiemmpos sobre todo con paquetes de pequeño porte. """)
st.markdown("***")
